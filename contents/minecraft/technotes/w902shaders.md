...
#### SEUS (Sonic Ether?ôs Unbelievable Shaders)

Performance Requirement: `High` | Summary: `Highly realistic, PT` ‚≠ê‚?‚≠?
...
Performance Requirement: `medium` | Summary: `Clear overall, PBR` ‚≠ê‚?‚≠?
...
Performance Requirement: `Medium` | Summary: `Fantasy colored lights, PBR` ‚≠ê‚?‚≠?
...
Performance Requirement: `high` | Summary: `RT` ‚≠ê‚?
...
Performance Requirement: `low` | Summary: `Vibrant colors` ‚≠ê‚?
...
Performance Requirement: `high` | Summary: `Realistic and clear, PT` ‚≠ê‚?‚≠?

Kappa Shaders is a good middle ground for players who want more realistic lighting and shadow effects, but don?ôt want to change the look of Minecraft too much overall. RRe36 is the creator of this shader, working on other shader projects like Kappa, KappaRT, Nostalgia, NostalgiaVX, Soft Voxel, Potato, Simplicissimus, UShader, Vanilla Plus
...
Performance Requirement: `medium` | Summary: `Legacy realistic classical feel` ‚≠ê‚?
...
Performance Requirement: `medium` | Summary: `Smooth RT gameplay` ‚≠ê‚?
...
Performance Requirement: `medium` | Summary: `Realistic` ‚≠ê‚?
...
Performance Requirement: `low` | Summary: `Realistic` ‚≠ê‚?

![chocapic13](/images/minecraft/shader/chocapic13.png)

Chocapic13?ôs Shaders mod is very easy for developers to work on. One of the best effects is actually the fog, which couples very well with dark and rainy nights.

#### Bliss

Performance Requirement: `low` | Summary: `Fantasy` ‚≠ê‚?
...
Performance Requirement: `medium` | Summary: `Cinematic view, PT` ‚≠ê‚?
...
Performance Requirement: `medium` | Summary: `Cinematic view` ‚≠ê‚?
...
Performance Requirement:  `medium` | Summary: `RT` ‚≠ê‚?
...
Performance Requirement:  `medium` | Summary: `Colored lights, RT` ‚≠ê‚?
...
Performance Requirement:  `high` | Summary: `Colored lights, RT` ‚≠ê‚?
...
Performance Requirement: `low` | Sumamry: `Vanilla Gameplay` ‚≠ê‚?
