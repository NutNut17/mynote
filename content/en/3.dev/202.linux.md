...
![Linux](/images/web/linux.svg){style="max-width: 192px; margin: 0 auto;"}

### Ubuntu

![Ubuntu](/images/web/ubuntu.svg){style="max-width: 192px; margin: 0 auto;"}

Debian Linux based OS, comes with preloaded packages

### Arch

![Arch Linux](/images/web/archlinux.svg){style="max-width: 192px; margin: 0 auto;"}
