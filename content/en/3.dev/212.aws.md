...
S3 (Simple Storage Service) stores files as objects inside buckets. It's used here to host all images for the site.
...
└── public/
    └── images/
        ├── cs/       ← algorithm and CS diagrams
        └── web/      ← technology logos and icons
```
