...
::div{class="grid grid-cols-1 sm:grid-cols-3 gap-4 my-12"}
  ::div{class="flex flex-col items-center"}
    ![GitHub](/images/web/github-icon.svg){max-width="80px" class="bg-white p-1 rounded"}
    ### GitHub
  ::
  ::div{class="flex flex-col items-center"}
    ![GitLab](/images/web/gitlab.svg){max-width="80px" class="p-2"}
    ### GitLab
  ::
  ::div{class="flex flex-col items-center"}
    ![BitBucket](/images/web/bitbucket.svg){max-width="80px" class="p-2"}
    ### BitBucket
  ::
::
...
![GitHub](/images/web/github-icon.svg){style="max-width: 192px; margin: 0 auto;" class="bg-white p-1 rounded"}
