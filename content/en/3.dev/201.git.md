...
::div{class="grid grid-cols-1 sm:grid-cols-3 gap-8 my-12"}
  :::div{class="flex flex-col items-center"}
    ![GitHub](/images/web/github-icon.svg){width="80" class="w-20 bg-white p-4 rounded-xl mb-4"}
    ### GitHub
  :::

  :::div{class="flex flex-col items-center"}
    ![GitLab](/images/web/gitlab.svg){width="80" class="w-20 mb-4"}
    ### GitLab
  :::

  :::div{class="flex flex-col items-center"}
    ![BitBucket](/images/web/bitbucket.svg){width="80" class="w-20 mb-4"}
    ### BitBucket
  :::
::
