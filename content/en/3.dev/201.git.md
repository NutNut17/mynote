...
::tip
Golden Rule: Always branch before making new feature. Gitignore data. Revert for rollback. Stage to save.
::

## Source Control

![Git](/images/web/git-icon.svg){width="192" class="mx-auto block my-8"}
...
![GitHub](/images/web/github-icon.svg){width="80" class="w-20 bg-white p-4 rounded-xl mb-4"} ### GitHub
:::

:::div{class="flex flex-col items-center"}
![GitLab](/images/web/gitlab.svg){width="80" class="w-20 mb-4"} ### GitLab
:::

:::div{class="flex flex-col items-center"}
![BitBucket](/images/web/bitbucket.svg){width="80" class="w-20 mb-4"} ### BitBucket
:::
::
...
![GitHub](/images/web/github-icon.svg){width="192" class="mx-auto block my-8 bg-white p-4 rounded-xl"}
