---
title: Cybersecurity
description: Overview of cryptographic concepts, web security practices, and infrastructure security.
navigation:
...
| Range | Notes |
| - | - |
| `172.16.0.0` ~ `172.31.255.255` | Private address. No public domain. Subnet mask Likely `255.255.255.0` or `255.255.0.0`. Often used by corporate internal and VPNs. The first half often reserved for internal infrastructure, the second half often reserved for virtual or remote services  |
| `192.168.` | Class B private address for homes |
| `10.` | For massive enterprises |
| `.0` & `.255` | reserved for broadcast address |
| `.254` | classic choice for a router or gateway |
