...
description: Advanced guide to data structures and algorithms including LeetCode solutions, trees, graphs, and sorting.
navigation:
  icon: i-lucide-git-graph
---

This page cover advanced topic. 
...
::collapsible{name="Array and Strings LeetCode Questions"}

:::tabs

::::tab-item{label="Two Sum - Easy"}
...
::::tab-item{label="Longest Substring Without Repeating Characters - Medium"}
...
::::tab-item{label="Mediam of Two Sorted Arrays"}
...
::collapsible{name="Linked List LeetCode Questions"}

:::tabs

::::tab-item{label="Remove Nth Node From End of List - Medium"}
...
![bst](/images/cs/bst.png){style="max-width: 400px; margin: 0 auto;"}
...
::collapsible{name="Tree LeetCode Questions"}

:::tabs

::::tab-item{label="Construct Binary Tree from Preorder and Inorder Traversal  - Medium"}
...
::::
::::tab-item{label="Construct Binary Tree from Preorder and Postorder Traversal - Medium"}
...
![avl1](/images/cs/avl1.png){style="max-width: 400px; margin: 0 auto;"}
...
![avl2](/images/cs/avl2.png){style="max-width: 400px; margin: 0 auto;"}
...
![redblacktree](/images/cs/redblacktree.png)
...
![dijkstra](/images/cs/dijkstra.png)
...
![bellman-ford](/images/cs/bellman-ford.png)
...
![closest-pair](/images/cs/closest-pair.png)
...
![voronoi](/images/cs/voronoi.png)

### Branch and Bound

**Personnel Assignment Problem**

![personnel](/images/cs/personnel1.png)
...
![knapsack](/images/cs/knapsack-bnb1.png)
...
![knapsack](/images/cs/knapsack-bnb2.png)

**Linear Programming (Prune and Search)**

![linear](/images/cs/linear-prune.png)
...
![knapsack01](/images/cs/knapsack01.png)
...
![knapsack02](/images/cs/knapsack02.png)

To find the optimal results, if the vertical arrow shows same number as the cell. Don't take that item.

::collapsible{name="DP LeetCode Questions"}

:::tabs

::::tab-item{label="Maxumum Product Subarray - Medium"}
...
::::
::::tab-item{label="Longest Increasing Subsequence - Medium"}
...
- Topological Sorting
- Max Flow / Min Cut (Ford-Fulkerson, Edmonds-Karp, Dinic): For graph-based resource allocation, network flow, image segmentation
- Strongly Connected Components (Tarjan / Kosaraju)
- Union-Find (Disjoint Set Union)
- Graph Coloring / Bipartite Checking
- Bitmask DP: Compress states, used for NP-hard approximation like Traveling Salesman Problem (TSP)
- Digit DP / Interval DP / Memory-efficient DP
- Trie + Bit Trie: String search, XOR maximization
- Suffix Array / Suffix Tree / LCP: String processing, genome comparison, compression
- Persistent Data Structures: Time travel, version control
...
- Greedy correctness with Matroids
