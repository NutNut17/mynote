---
title: Three.js
description: Introduction to Three.js, computer graphics concepts, and examples.
navigation:
  icon: i-simple-icons-threedotjs
---

![Three.js](/images/web/three.svg){style="max-width: 192px; margin: 0 auto;"}
...
to: /en/cs/graphics/
---
Learn about the basic concepts of computer graphics
::
...
![Reflection](/images/web/reflection.png)

::card-group
  ::card
  ---
  title: Little Tokyo
  to: https://threejs.org/examples/#webgl_animation_keyframes
  ---
  ::

  ::card
  ---
  title: Material Car Ferrari
  to: https://threejs.org/examples/#webgl_materials_car
  ---
  ::
  ...
  to: https://threejs.org/examples/#webgpu_pmrem_equirectangular
  ---
  ::
  ...
  ---
  title: Mirror
  to: https://threejs.org/examples/#webgpu_mirror
  ---
  ::
  ...
  ---
  title: Games FPS
  to: https://threejs.org/examples/#games_fps
  ---
  ::
  ...
  to: https://threejs.org/examples/#physics_ammo_terrain
  ---
  ::
  ...
  ---
  title: Misc Exporter
  to: https://threejs.org/examples/#misc_exporter_ply
  ---
  ::
  ...
  to: https://threejs.org/examples/#css3d_periodictable
  ---
  ::
  ...
  ---
  title: 3D Sprites
  to: https://threejs.org/examples/#css3d_sprites
  ---
  ::
  ...
  ---
  title: Youtube Cube
  to: https://threejs.org/examples/#css3d_youtube
  ---
  ::
  ...
  ---
  title: Light Probe
  to: https://threejs.org/examples/webgl_lightprobe.html
  ---
  ::
  ...
  to: https://threejs.org/examples/#webgl_geometry_colors
  ---
  ::
::

## Other Web Graphics Applications
