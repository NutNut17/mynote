---
title: Express.js
description: Setting up Express.js web and database servers using Node.js, SQLite, and Sequelize.
navigation:
  icon: i-simple-icons-express
---

::div{class="my-6 bg-white dark:bg-zinc-800 p-3 rounded-lg w-fit"}
![Express](/images/web/express.svg){style="max-width: 1080px; margin: 0 auto;"}
::
...
to: https://mertgursoy.medium.com/how-to-create-a-basic-to-do-crud-app-using-vue3-nodejs-expressjs-server-sqlite-vite-03a29509ada4
target: _blank
---
A reference to setup a fullstack frontend and backend using Vue and Express.js
::
