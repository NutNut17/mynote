...
::div{.flex.flex-row.justify-around.gap-12.my-12}
![HTML5](/images/web/html-5.svg){style="max-width: 150px;"}![CSS3](/images/web/css-3.svg){style="max-width: 150px;"}![JavaScript](/images/web/javascript.svg){style="max-width: 150px;"}
::
...
::card{icon="i-logos-javascript" title="JavaScript" to="/en/web/javascript"}
...
::div{.bg-muted/10.rounded.overflow-hidden.border.border-muted/20}
  :::div{.p-4.text-center.text-muted.text-sm.italic}
...
::card{title="Tailwind CSS" to="/en/web/tailwind-css"}
...
| ----------- | ------------------------------------------------------------------------------------------- |
| Serif       | [Classic, traditional official fonts]{style="font-family: 'Times New Roman', Times, serif"} |
| Sans-serif  | [Modern, simple fonts]{style="font-family: Arial, Helvetica, sans-serif"}                   |
| Monospace   | [Every character have same width]{style="font-family: 'Courier New', Courier, monospace"}   |
| Cursive     | [Cursive writing]{style="font-family: 'Comic Sans MS', cursive"}                            |
...
::div{.flex.justify-around.my-12}
![Nuxt](/images/web/nuxt.svg){style="max-width: 192px; margin: 0 auto;"}![Next.js](/images/web/nextjs.svg){style="max-width: 192px; margin: 0 auto;"}
::

::card{icon="i-logos-vue" title="Vue" to="/en/web/vue"}
Click here to explore more about Vue, Nuxt.js framework
::

::card{icon="i-logos-react" title="React" to="/en/web/react"}
...
::card{title="Production" to="/en/web/production"}
...
A fast, modern build tool and development server for JavaScript and TypeScript projects. It focuses on lightning-fast cold starts and efficient bundling for production. It can handle CSR, SSR, SSG, Dynamic Rendering. [Vite website](https://vite.dev/)
...
::card{title="Express.js" to="/web/express"}
...
::div{.flex.flex-row.justify-around.gap-12.my-12}
![postgresql](/images/web/postgresql.svg){style="max-width: 150px;"}![mysql](/images/web/mysql.svg){style="max-width: 150px;"}![sqlite](/images/web/sqlite.svg){style="max-width: 150px;"}
::
...
::div{.grid.grid-cols-1.sm:grid-cols-4.gap-4.my-12}
  :::div
  ---
  class: flex justify-center p-4 bg-muted/5 rounded-lg border border-muted/10
  style: "max-width: 150px;"
  ---
  ![MongoDB](/images/web/mongodb-icon.svg){width="80"}
  :::
  ...
  style: "max-width: 150px;"
  ---
  ![Firestore](/images/web/firestore.svg){width="80"}
  :::
  ...
  style: "max-width: 150px;"
  ---
  ![Redis](/images/web/redis.svg){width="80"}
  :::
  ...
  style: "max-width: 150px;"
  ---
  ![Neo4j](/images/web/neo4j.svg){width="80"}
  :::
::
