...
description: Principles of Responsive Web Design (RWD), CSS Flexbox, and Bootstrap layoutting.
navigation:
...
The focus of RWD is designing on mobile layoutting first, then expand to desktop layout.
...
2. Make a container. Ensure it inherit the width of the body parent, overflow will scroll in this container.
