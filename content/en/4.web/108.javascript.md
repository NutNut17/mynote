---
title: JavaScript
description: Introduction to JavaScript basics including variables, operators, functions, objects, data structures, and asynchronous programming.
navigation:
  icon: i-simple-icons-javascript
---

![JavaScript](/images/web/javascript.svg){style="max-width: 192px; margin: 0 auto;"}
